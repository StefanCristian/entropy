...
class RepositoryConfigParser(BaseConfigParser):
    ...
    [server=argent-untested]
    desc = Kogaion Linux Official Testing Repository
    repo = ssh://username@full.host:~username/argent-untested
    enabled = <true/false>

    [server=argent-untested]
    desc = This statement will be ignored.
    repo-only = ssh://username@repo.host:~username/argent-untested
    pkg-only = ssh://username@pkg.host:~username/argent-untested
